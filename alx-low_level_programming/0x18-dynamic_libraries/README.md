...
-   You can't modify the program `gm` itself as Master Sysadmin Sylvain (MSS) always checks its [MD5]([https://alx-intranet.hbtn.io/rltoken/njnwPTMpc1-RSp5sVEAyfg](https://github.com/holbertonschool/0x18.c/blob/master/101-md5_gm) "MD5") before running it
